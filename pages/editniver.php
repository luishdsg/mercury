...
$id_edit = $_GET['id_postniver'];
include "../connect.php";
$sql = "select * from postniver WHERE id_postniver = '$id_edit'";

$result = mysqli_query($link, $sql);
while($updates = mysqli_fetch_array($result)){
    $nome_up = $updates['nome_list'];
    $acomp_up = $updates['acomp_list'];
...
?>
        ...
        <div class="content w-100 mpal pab">
            <div style="margin:0 0 0 -10px !important;" class="row pt-1 content-p">
                <form action='../editniver_d.php' method="post" class='form bg-dark'>
